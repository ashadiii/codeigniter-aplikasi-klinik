...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?=base_url();?>assets/css/dist/css/AdminLTE.min.css">
  <!-- iCheck -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('');?>"><b>Erha</b> Klinik</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php echo $this->session->flashdata('logoutadmin'); ?>
...
<!-- iCheck -->
<script src="<?=base_url();?>assets/css/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
